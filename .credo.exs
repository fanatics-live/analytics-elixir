  ...
  configs: [
    %{
      ...
      files: %{
        ...
        excluded: [~r"/_build/", ~r"/deps/", ~r"/node_modules/", "**/*.pb.ex"]
      },
      #
      ...
      checks: %{
        enabled: [
          ...
          {Credo.Check.Readability.RedundantBlankLines, [priority: :low, max_blank_lines: 2]},
          ...
          ## CredoContrib checks
          #
          {CredoContrib.Check.DocWhitespace, false},
        ...
        disabled: [
          ...
          #
          # This check seems particularly low value. Disabled.
          {Credo.Check.Consistency.UnusedVariableNames, []},
          {Credo.Check.Readability.NestedFunctionCalls, []},
          {Credo.Check.Readability.OnePipePerLine, []},
          # TODO Enable this check once we've added specs
          {Credo.Check.Readability.Specs, []},
          {Credo.Check.Readability.SinglePipe, []},
          {Credo.Check.Refactor.PassAsyncInTestCases, []},
          # This check is not compatible with current versions of Elixir
